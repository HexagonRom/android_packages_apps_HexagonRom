...
public class ColorPickerPreference extends Preference implements
    ...
    static final String HEXAGONEXTRAS = "http://schemas.android.com/apk/res/com.droidvnteam";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int defVal = attrs.getAttributeIntValue(HEXAGONEXTRAS, "defaultColorValue", DEF_VALUE_DEFAULT);
