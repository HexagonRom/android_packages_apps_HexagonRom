...
public class PulseSettings extends BaseSettingsFragment implements
    ...
    SeekBarPreferenceCham mSolidCount;
    SeekBarPreferenceCham mSolidOpacity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSolidCount =
                (SeekBarPreferenceCham) findPreference(PULSE_SOLID_UNITS_COUNT);
        ...
        mSolidOpacity =
                (SeekBarPreferenceCham) findPreference(PULSE_SOLID_UNITS_OPACITY);
